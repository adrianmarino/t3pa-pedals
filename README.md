...
Arduino firmware that allows convert `T3PA Pedals` to `USB`. It allows to use `T3PA Pedals` with other wheel bases as a regular 3 axis joystick. Is important note that this firmware allows to convert anu Pedals to USB or build your own pedals and used it through USB port as a regular 3 axis joystick. Both the circuit and firmware are agnostic, could be used for any pedals project.
